...
// Top-level validators (Zod 4) — replaces z.string().email() etc.
const emailSchema = z.email();
const uuidSchema = z.uuid();
const urlSchema = z.url();

// ISO date/time string validators (Zod 4) — replaces z.string().date() etc.
// z.date() validates a JS Date object; z.iso.date() validates a YYYY-MM-DD string
const isoDateSchema = z.iso.date();       // "2024-01-01"
const isoDateTimeSchema = z.iso.datetime(); // "2024-01-01T00:00:00Z"
const isoTimeSchema = z.iso.time();       // "00:00:00"
